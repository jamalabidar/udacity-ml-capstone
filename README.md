...
### The AUC score for the VAR algorithm is at 0.597. It is slightty better than random guess.
...
rnn_recurrent_dropout = 0.0 # % of neuros to turn off while training RNN Cells
dense_dropout = 0.0 # % of neuros to turn off while training Dense network
...
activation_dense = "relu" #Activation function for the dense layer
...
We could have created a custom AUC metric but it was not working properly and the training could not be launched with this custom metric.

The AUC will be calculated on the test dataset after the mode training.
...
```python
model = keras.models.Model(inputs=[encoder_inputs, decoder_inputs], outputs=final_decoder_outputs)
...
```
    ...
    __________________________________________________________________________________________________
    dropout_1 (Dropout)             (None, None, 1)      0           dense_1[0][0]                    
    ==================================================================================================
    Total params: 24,737
...
```
    ...
    Epoch 1/30
    200/200 [==============================] - 2s 11ms/step - loss: 0.4218 - val_loss: 0.9190
    Epoch 2/30
    200/200 [==============================] - 1s 3ms/step - loss: 0.3076 - val_loss: 0.6447
    Epoch 3/30
    200/200 [==============================] - 1s 3ms/step - loss: 0.2782 - val_loss: 0.5889
    Epoch 4/30
    200/200 [==============================] - 1s 3ms/step - loss: 0.2493 - val_loss: 0.5627
    Epoch 5/30
    200/200 [==============================] - 1s 3ms/step - loss: 0.2367 - val_loss: 0.5316
    Epoch 6/30
    200/200 [==============================] - 1s 4ms/step - loss: 0.2111 - val_loss: 0.5119
    Epoch 7/30
    200/200 [==============================] - 1s 4ms/step - loss: 0.2078 - val_loss: 0.5005
    Epoch 8/30
    200/200 [==============================] - 1s 4ms/step - loss: 0.2141 - val_loss: 0.4961
    Epoch 9/30
    200/200 [==============================] - 1s 4ms/step - loss: 0.2057 - val_loss: 0.4917
    Epoch 10/30
    200/200 [==============================] - 1s 4ms/step - loss: 0.2002 - val_loss: 0.4882
    Epoch 11/30
    200/200 [==============================] - 1s 4ms/step - loss: 0.2045 - val_loss: 0.4831
    Epoch 12/30
    200/200 [==============================] - 1s 4ms/step - loss: 0.1978 - val_loss: 0.4811
    Epoch 13/30
    200/200 [==============================] - 1s 4ms/step - loss: 0.1985 - val_loss: 0.4784
    Epoch 14/30
    200/200 [==============================] - 1s 4ms/step - loss: 0.2003 - val_loss: 0.4713
    Epoch 15/30
    200/200 [==============================] - 1s 3ms/step - loss: 0.1955 - val_loss: 0.4710
    Epoch 16/30
    200/200 [==============================] - 1s 3ms/step - loss: 0.1948 - val_loss: 0.4715
    Epoch 17/30
    200/200 [==============================] - 1s 3ms/step - loss: 0.1947 - val_loss: 0.4722
    Epoch 18/30
    200/200 [==============================] - 1s 3ms/step - loss: 0.1983 - val_loss: 0.4727
    Epoch 19/30
    200/200 [==============================] - 1s 3ms/step - loss: 0.1979 - val_loss: 0.4729
    Epoch 20/30
    200/200 [==============================] - 1s 3ms/step - loss: 0.1932 - val_loss: 0.4732
    Epoch 21/30
    200/200 [==============================] - 1s 4ms/step - loss: 0.1941 - val_loss: 0.4749
    Epoch 22/30
    200/200 [==============================] - 1s 4ms/step - loss: 0.1945 - val_loss: 0.4742
    Epoch 23/30
    200/200 [==============================] - 1s 4ms/step - loss: 0.1960 - val_loss: 0.4747
    Epoch 24/30
    200/200 [==============================] - 1s 4ms/step - loss: 0.1927 - val_loss: 0.4763
    Epoch 25/30
    200/200 [==============================] - 1s 4ms/step - loss: 0.1966 - val_loss: 0.4783
    Epoch 26/30
    200/200 [==============================] - 1s 4ms/step - loss: 0.1933 - val_loss: 0.4816
    Epoch 27/30
    200/200 [==============================] - 1s 4ms/step - loss: 0.1944 - val_loss: 0.4839
    Epoch 28/30
    200/200 [==============================] - 1s 4ms/step - loss: 0.1925 - val_loss: 0.4846
    Epoch 29/30
    200/200 [==============================] - 1s 3ms/step - loss: 0.1916 - val_loss: 0.4857
    Epoch 30/30
    200/200 [==============================] - 1s 4ms/step - loss: 0.1932 - val_loss: 0.4858
...
We can clearly see that the training loss decreases steadily and that the validation loss decreases as well.
At 15 epochs the training and validation losses seem to stabilize.
...
However, tuning all hyperparameters did not prevent the validation loss from decreasing to values lower than 0.47. The gap between the training loss and validation  loss can be a sign of underfitting (depending on the scales). We will consider it underfitting in this case as both training and validation losses (binary cross entropy) are still high after 30 epochs (0.19 and 0.48).
...
And the advantage is confirmed when we compare the results quantitatively: we see a significant AUC improvement (9% improvement) for the Seq2Seq model. But this improvement came with a lot of effort for data preparation and hyperparameter tunning.

Even though the quantitative comparison is in favor of the Seq2Seq algorithm, the qualitative comparison is very explicitly going in favor of the VAR algorithm. Compared to the Seq2Seq model, the VAR models clearly shows higher peaks near the actual failure days. Instead, the Seq2Seq model tried to have the best possible binary cross entropy loss even it that means having an almost flat prediction.
...
As an indication, the leaderboard of the Kaggle competition ([leaderboard](https://www.kaggle.com/c/predictive-maintenance1/leaderboard)) shows that a result of 0.652 would be at the third position. 

My AUC was not calculated on the same data so we can not compare but that shows an indication of the difficulty of this problem and the corresponding dataset.


```python
!jupyter nbconvert --to markdown capstone_project.ipynb
```

    [NbConvertApp] Converting notebook capstone_project.ipynb to markdown
    [NbConvertApp] Support files will be in capstone_project_files\
    [NbConvertApp] Making directory capstone_project_files
    [NbConvertApp] Making directory capstone_project_files
    [NbConvertApp] Making directory capstone_project_files
    [NbConvertApp] Making directory capstone_project_files
    [NbConvertApp] Making directory capstone_project_files
    ...
    [NbConvertApp] Making directory capstone_project_files
    [NbConvertApp] Making directory capstone_project_files
    [NbConvertApp] Writing 113853 bytes to capstone_project.md
